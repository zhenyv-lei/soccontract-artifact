# =============================================================================
# Sodor-S CPU_TCI(C1) WITH PMP constraint
# =============================================================================
# Same as Sodor C1, but with PMP assume added.
# PMP should not affect C1 result (C1 doesn't involve interrupt).
# Expected result: PASS (same as Sodor C1)
# =============================================================================
...
save -jdb results/my_jdb_sodor_s_cpu_c1 -capture_setup -capture_session_data -force
exit
