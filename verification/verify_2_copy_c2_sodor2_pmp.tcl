# =============================================================================
# Sodor-S CPU_TCI(C2) WITH PMP constraint
# =============================================================================
# Same as Sodor C2, but with PMP assume added.
# PMP should not affect C2 result (C2 doesn't involve interrupt).
# Expected result: PASS (same as Sodor C2)
# =============================================================================
...
save -jdb results/my_jdb_sodor_s_cpu_c2 -capture_setup -capture_session_data -force
exit
