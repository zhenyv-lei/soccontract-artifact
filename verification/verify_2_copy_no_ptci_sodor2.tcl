...
# Expected result: FAIL (model checker injects different dmem timing)
# This demonstrates that platform timing constraints are necessary.
# =============================================================================

analyze -sva src/sodor2/sodor_2_stage.sv src/sodor2/two_copy_top_no_ptci.sv src/sodor2/param.vh
...
save -jdb my_jdb_no_ptci_2copy_sodor2 -capture_setup -capture_session_data -force
