...
This directory contains experiment-specific JasperGold TCL scripts.

- `veri_*.tcl`: verification configurations used for individual experiments.
- `extract_cex_signals*.tcl`: counterexample signal extraction helpers.
