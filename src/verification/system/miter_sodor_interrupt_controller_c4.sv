...
// =============================================================================
// Sodor + Interrupt Controller: Direct Full-System Verification under C4
// =============================================================================
// The experiment script optionally adds a PMP constraint. Historical results:
// without PMP, the proof timed out after seven days; with PMP, it passed.
// =============================================================================

`define PERIPH_START 0
`define PERIPH_END   1

module miter_sodor_interrupt_controller_c4(
    input clk,
    input rst
);
