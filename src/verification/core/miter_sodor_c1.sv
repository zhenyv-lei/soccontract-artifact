...
// =============================================================================
// Phase 1a: Core Verification under C1 Platform Timing Contract
// =============================================================================
// C1 contract (ideal memory, address-independent timing):
//   (1) req   -> diamond{gnt, rdata}   request affects timing AND data
//   (2) addr  -> diamond{rdata}        address affects data only (NOT timing)
//   (3) we    -> diamond{rdata}        write-enable affects data only
//   (4) wdata -> diamond{rdata}        write-data affects data only
//
...
// =========================================================================
// PTCI: C1 Contract - Sticky-one logic for diamond operator
// =========================================================================
...
Core copy1(
    ...
    // interrupts -- tied to 0 (no interrupts in C1)
...
// Monitor completion and timing divergence across the two core copies.
// =========================================================================
