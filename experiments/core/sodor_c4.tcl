...
analyze -sva src/verification/core/miter_sodor_c4.sv

elaborate -top miter_sodor_c4 -bbox_mul 256 -bbox_a 1024 -bbox_m plusarg_reader -bbox_m GenericDigitalInIOCell -bbox_m GenericDigitalOutIOCell -bbox_m ClockDividerN -bbox_m EICG_wrapper
clock clk
...
save -jdb my_jdb_sodor_cpu_c4_no_pmp -capture_setup -capture_session_data -force
exit
