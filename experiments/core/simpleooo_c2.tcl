# =============================================================================
# SimpleOoO (NoFwd): Core Verification under C2
# =============================================================================
...
analyze +define+RF_SIZE=4+RF_SIZE_LOG=2+MEMI_SIZE=16+MEMI_SIZE_LOG=4+MEMD_SIZE=4+MEMD_SIZE_LOG=2+ROB_SIZE=4+ROB_SIZE_LOG=2+BR_PREDICT=0+USE_DEFENSE_PARTIAL_STT=+PARTIAL_STT_USE_SPEC=+OBSV=0+INIT_VALUE=0+IMM_STALL= -sva src/verification/core/miter_simpleooo_c2.v

elaborate -top miter_simpleooo_c2 -bbox_mul 256
clock clk
...
prove -all
save -jdb my_jdb_simpleooo_c2 -capture_setup -capture_session_data -force
get_design_info
exit
