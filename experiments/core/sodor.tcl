# =============================================================================
# Sodor: Core Verification under the C3 Platform Timing Contract
# =============================================================================
...
analyze -sva src/core/sodor/sodor_2_stage.sv src/verification/core/miter_sodor_c3.sv src/core/sodor/param.vh

elaborate -top miter_sodor_c3 -bbox_mul 256 -bbox_a 1024 -bbox_m plusarg_reader -bbox_m GenericDigitalInIOCell -bbox_m GenericDigitalOutIOCell -bbox_m ClockDividerN -bbox_m EICG_wrapper
clock clk
...
save -jdb my_jdb_sodor -capture_setup -capture_session_data -force
