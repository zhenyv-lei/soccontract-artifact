...
# Historical result: TIMEOUT after the configured 7-day limit
# =============================================================================

analyze -sva src/verification/system/miter_sodor_interrupt_controller_c4.sv

elaborate -top miter_sodor_interrupt_controller_c4 -bbox_mul 256 -bbox_a 1024 -bbox_m plusarg_reader -bbox_m GenericDigitalInIOCell -bbox_m GenericDigitalOutIOCell -bbox_m ClockDividerN -bbox_m EICG_wrapper
clock clk
...
# Direct full-system control
set_prove_orchestration off
set_engine_mode {Ht}
set_prove_time_limit 7d
prove -all

save -jdb my_jdb_sodor_cpu_c4_combined_no_pmp -capture_setup -capture_session_data -force
exit
