# =============================================================================
# Sodor + Regular Cache: Direct Full-System Verification under C2
# =============================================================================
# Expected: PASS (Sodor has no speculative execution)
# =============================================================================

analyze -sva src/verification/system/miter_sodor_regular_cache_c2.sv

elaborate -top miter_sodor_regular_cache_c2 -bbox_mul 256 -bbox_a 1024 -bbox_m plusarg_reader -bbox_m GenericDigitalInIOCell -bbox_m GenericDigitalOutIOCell -bbox_m ClockDividerN -bbox_m EICG_wrapper
clock clk
...
save -jdb my_jdb_sodor_regular_cache_c2 -capture_setup -capture_session_data -force
exit
